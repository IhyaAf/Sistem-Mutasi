...
<option value="UP2k.php?unit2=Unit Pelaksana Proyek Ketenagalistrikan (UP2K) Provinsi Sumatera Utara" selected>Unit Pelaksana Proyek Ketenagalistrikan (UP2K) Provinsi Sumatera Utara</option>
...
?>
  ...
  <script type="text/javascript">
   var nama = 'Jabatan';
    ...
    var datascource = {
      <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Manager Unit Pelaksana Proyek Ketenagalistrikan'";
                  ...
                  ?>
      'name': nama,
      'title': 'Manager Unit Pelaksana Proyek Ketenagalistrikan<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>',
      'children': [
    ...
    { 
        <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Konstruksi'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  ?>
      'name': nama, 'title': 'Supervisor Konstruksi<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>' },
    { 
        <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Perencanaan Listrik Pedesaan'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  ?>
      'name': nama, 'title': 'Supervisor Perencanaan Listrik Pedesaan<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>' }
    ]
