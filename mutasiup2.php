...
<option value="MUTASIUP2.PHP?unit2=Unit Pelaksana Pengatur Distribusi (UP2D) Sumatera Utara " selected>Unit Pelaksana Pengatur Distribusi (UP2D) Sumatera Utara</option>
...
?>
  ...
  <script type="text/javascript">
   var nama = 'RAIS';
    ...
    var datascource = {
      <?php
          $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Manager Unit Pelaksana Pengatur Distribusi'";
          ...
          ?>   
      'name': nama,
      'title': 'Manager Unit Pelaksana Pengatur Distribusi<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>',
      'children': [
          ...
          'children':[
                ...
                { 
                  <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Pejabat Pelaksana Keselamatan,Kesehatan kerja,Keamnan dan Lingkungan(K3L)'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  ?>
                  'name': nama, 'title': 'Pejabat Pelaksana Keselamatan,Kesehatan kerja,Keamnan dan Lingkungan(K3L)<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>' },
                { 
                  <?php
                  $sql = "SELECT * FROM data_pegawai  where UNIT2='$unit' AND JABATAN = 'Pejabat Pelaksana Pengadaan'";
                  $result = mysqli_query($conn, $sql);
        ...
        { 
          <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Manager Bagian Fasilitas Oprasi'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  ?>
          'name': nama, 'title': 'Manager Bagian Fasilitas Oprasi<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>',
          'children': [
            { 
              <?php
                  $sql = "SELECT * FROM data_pegawai  where UNIT2='$unit' AND JABATAN = 'Supervisor Perencanaan SCADA'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  ?>
              'name': nama, 'title': 'Supervisor Perencanaan SCADA<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>'},
                            
              { 
                <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Remote Terminal Unit (RTU) dan peripheral'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  ?>
                'name': nama, 'title': 'Supervisor Remote Terminal Unit (RTU) dan peripheral<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>' },
              { 
                <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor SCADA dan Telekomunikasi'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  ?>
                'name': nama, 'title': 'Supervisor SCADA dan Telekomunikasi<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>' }
                        ]
            },
            ...
            { 
              <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Manager Bagian Keuangan, SDM dan Administrasi'";
                  $result = mysqli_query($conn, $sql);
              ...
              { 
                <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Keuangan dan Akuntansi'";
                  $result = mysqli_query($conn, $sql);
              ...
              { 
                <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor SDM dan Administrasi'";
                  $result = mysqli_query($conn, $sql);
            ...
            { 
              <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Manager Bagian Operasi Sistem Distribusi'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  ?>
              'name': nama, 'title': ' Manager Bagian Operasi Sistem Distribusi<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>',
          'children': [
              { 
                <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Operasi'";
                  $result = mysqli_query($conn, $sql);
              ...
              { 
                <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Pemeliharaan Elektromekanik'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  ?>
                'name': nama, 'title': 'Supervisor Pemeliharaan Elektromekanik<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>' },                
              { 
                <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Pengelolaan Data dan Gambar'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  ?>
                'name': nama, 'title': 'Supervisor Pengelolaan Data dan Gambar<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>' },
              { 
                <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Perencanaan Pemeliharaan'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  ?>
                'name': nama, 'title': 'Supervisor Perencanaan Pemeliharaan<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>' },
              { 
                <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Perencanaan dan Evaluasi Operasi'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  ?>
                'name': nama, 'title': 'Supervisor Perencanaan dan Evaluasi Operasi<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>' },
              { 
                <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Proteksi dan Meter'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  ?>
                'name': nama, 'title': 'Supervisor Proteksi dan Meter<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>' }
                       ]
