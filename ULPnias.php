...
<option value="ULPnias.PHP?unit1=Unit Layanan Pelanggan (ULP) Nias Barat" selected>Unit Layanan Pelanggan (ULP) NIAS</option>
...
<select name="unit1"  id="mySelect"onchange="myFunctioner()">
                                   <optgroup label="select unit">
                                       <?php
                                       $sqli = "SELECT * FROM unit WHERE unit2 <> unit1 AND unit2 = 'Unit Pelaksana Pelayanan Pelanggan (UP3) Nias'";
                                       ...
                                       ?>
                                                    <option value="<?php echo $rows['unit1'] ?>" <?php 
                                                    if (($unit == $rows['unit1'])||($unit." " == $rows['unit1'])) 
                                                    {echo "selected";} 
                                                    ?>>
                                                    <?php echo $rows['unit1'] ?></option>
                                                    <?php 
...
function myFunctioner() {
  ...
  window.location = 'ULPnias.php?unit1='+x;
}
</script>
 <script>
  ...
  <script type="text/javascript">
   var nama = 'Jabatan';
    $(function() {
     ...
     var datascource = {
      <?php
                  $sql = "SELECT * FROM data_pegawai where  UNIT1 = '$unit' && JABATAN = 'Manager Unit Layanan Pelanggan'";
      ...
      ?>
      'name': nama,
      'title': 'Manager Unit Layanan Pelanggan<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>',
      'children': [

          { 
            <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT1 = '$unit' && JABATAN = 'Pejabat Pelaksana Keselamatan, Kesehatan Kerja, Keamanan, dan Lingkungan (K3L) Supervisor Dasar Cetak'";
                  $result = mysqli_query($conn, $sql);
            ...
            ?>
            'name': nama, 'title': 'Pejabat Pelaksana Keselamatan, Kesehatan Kerja, Keamanan, dan Lingkungan (K3L) <br> Supervisor Dasar Cetak<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a> ' },
    { 
      <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT1 = '$unit' && JABATAN = 'Supervisor Pelayanan Pelanggan dan Administrasi'";
                  $result = mysqli_query($conn, $sql);
      ...
      ?>
      'name': nama, 'title': 'Supervisor Pelayanan <br> Pelanggan dan Administrasi<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>' },
    { 
      <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT1 = '$unit' && JABATAN = 'Supervisor Teknik'";
                  $result = mysqli_query($conn, $sql);
      ...
      ?>
      'name': nama, 'title': 'Supervisor Teknik<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>' },
    { 
      <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT1 = '$unit' && JABATAN = 'Supervisor Transaksi Energi'";
                  $result = mysqli_query($conn, $sql);
      ...
      ?>
      'name': nama, 'title': 'Supervisor Transaksi Energi<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>' },
    { 
      <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT1 = '$unit' && JABATAN = 'Supervisor Pembangkit'";
                  $result = mysqli_query($conn, $sql);
      ...
      ?>
      'name': nama, 'title': 'Supervisor Pembangkit<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>' }
    ]
