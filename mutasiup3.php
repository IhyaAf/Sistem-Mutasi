...
<option value="mutasiup3.php?unit2=Unit Pelaksana Pelayanan Pelanggan (UP3) Binjai" selected>Manager Unit Pelaksana Pelayanan Pelanggan ( UP3 )</option>
...
<select name="unit1"  id="mySelect"onchange="myFunctioner()">
                                   <optgroup label="select unit">
                                       <?php
                                       $sqli = "SELECT DISTINCT unit2 FROM unit WHERE unit2 <> 'Unit Induk Wilayah (UIW) Sumatera Utara'";
                                       $results = $conn->query($sqli);
                                       
                                       if ($results->num_rows > 0) {
                                           while($rows = $results->fetch_assoc()) {
                                            if (($rows['unit2'] != "Unit Pelaksana Pelayanan Pelanggan (UP3) Nias")&&($rows['unit2'] != "Unit Pelaksana Pengatur Distribusi (UP2D) Sumatera Utara ")&&($rows['unit2'] != "Unit Pelaksana Proyek Ketenagalistrikan (UP2K) Provinsi Sumatera Utara")){
                                       ?>   
                                                    <option value="<?php echo $rows['unit2'] ?>" <?php 
                                                    if (($unit == $rows['unit2'])||($unit." " == $rows['unit2'])) 
                                                    {echo "selected";} 
                                                    ?>>
                                                    <?php echo $rows['unit2'] ?></option>
                                                    <?php 
                                            }
                                           }
                                       }
...
function myFunctioner() {
  ...
  window.location = 'mutasiup3.php?unit2='+x;
}
</script>
 ...
 <script type="text/javascript" src="jquery.min.js"></script>
  ...
  <script type="text/javascript">
   var nama = 'Jabatan';
    ...
    var datascource = {
      <?php
      $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Manager Unit Pelaksana Pelayanan Pelanggan'";
      ...
      'children': [
          ...
          'children':[
                ...
                { 
                  <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Pejabat Pelaksana Keselamatan,kesehatan kerja dan lingkungan'";
                  $result = mysqli_query($conn, $sql);
                ...
                { 
                  <?php
                  $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Pejabat Perencana Pengadaan'";
                  $result = mysqli_query($conn, $sql);
        ...
        {
          <?php
          $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Manager Bagian Jaringan'";
          $result = mysqli_query($conn, $sql);
      ...
      { 
        <?php
          $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor PDKB'";
          $result = mysqli_query($conn, $sql);
        ...
        'name': nama, 'title': 'Supervisor PDKB<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>',
            ...
            { 
              <?php
              $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Pemeliharaan'";
              $result = mysqli_query($conn, $sql);
 ...
 { 
  <?php
          $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Manager Bagian Konstruksi'";
          $result = mysqli_query($conn, $sql);
          ...
          ?>
  'name': nama, 'title': 'Manager Bagian Konstruksi<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>',
          'children': [
            { 
              <?php
              $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Logistik'";
              $result = mysqli_query($conn, $sql);
              ...
              ?>
              'name': nama, 'title': 'Supervisor Logistik<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>',
 ...
 { 
  <?php
          $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Manager Bagian Pemasaran dan Pelayanan Pelanggan'";
          $result = mysqli_query($conn, $sql);
  ...
  'name': nama, 'title': 'Manager Bagian Pemasaran dan Pelayanan Pelanggan<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>',
          'children': [
            { 
              <?php
              $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor  Pemasaran dan Pelayanan Pelanggan'";
              $result = mysqli_query($conn, $sql);
   ...
   {
    <?php
          $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Manager Bagian Perencanaan'";
          $result = mysqli_query($conn, $sql);
    ...
    'name': nama, 'title': 'Manager Bagian Perencanaan<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>',
          'children': [
            { 
              <?php
              $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Mapping Data Jaringan dan Pelanggan'";
              $result = mysqli_query($conn, $sql);
      ...
      { 
        <?php
          $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Perencanaan Sistem'";
          $result = mysqli_query($conn, $sql);
   ...
   { 
    <?php
          $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Manager Bagian Transaksi Energi Listrik'";
          $result = mysqli_query($conn, $sql);
    ...
    'name': nama, 'title': 'Manager Bagian Transaksi Energi Listrik<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>',
          'children': [
            {
              <?php
              $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Pemeliharaan Meter Transaksi'";
              $result = mysqli_query($conn, $sql);
      ...
      { 
        <?php
          $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Pengendalian Susut'";
          $result = mysqli_query($conn, $sql);
        ...
        'name': nama, 'title': 'Supervisor Pengendalian Susut<br><a href="kronologi.php?nip=<?php echo $nip ?>"><?php echo $r ?></a>',
            ...
            { 
              <?php
              $sql = "SELECT * FROM data_pegawai where UNIT2='$unit' AND JABATAN = 'Supervisor Transaksi Energi Listrik'";
              $result = mysqli_query($conn, $sql);
